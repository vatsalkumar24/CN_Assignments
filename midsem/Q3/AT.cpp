...
int main()
{
    ...
    if((nufd_r1=accept(sfd1, (struct sockaddr*)&r1_addr, (socklen_t *)&len1))<0)
    {
    ...
    if((nufd_r2=accept(sfd2, (struct sockaddr*)&r2_addr, (socklen_t *)&len2))<0)
    {
    ...
    if((nufd_r3=accept(sfd3, (struct sockaddr*)&r3_addr, (socklen_t *)&len3))<0)
    {
