...
int main()
{
    ...
    cout<<"SFD received succesfully from client 3!"<<endl;
    ...
    int count = 0;
    while(nusfd = accept(usfd,NULL,NULL)<0)
	{
        cout<<"waiting for new client for 10s....";
        sleep(10);
        if(count==1){ cout<<"No client appeared, bye bye.."<<endl; return 0;}
        count++;
	}
    ...
    cout<<"SFD passed succcessfully to client 5!"<<endl;
